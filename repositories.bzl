...
def go_repositories():
    ...
    go_repository(
        ...
        #replace = "k8s.io/api",
        #sum = "h1:WiE134uexhvhHw4DjJuYsghv792UCe2xN5SHQOayf28=",
        #version = "v0.0.0-20190717022910-653c86b0609b",
        commit = "653c86b0609b",
    )
    ...
    go_repository(
        ...
        #sum = "h1:YiByKa40XFdQcmAcODmTcLcqDx/8itlK+Zj/1/bkjJY=",
        #version = "v0.0.0-20190717023132-0c47f9da0001",
        commit = "0c47f9da0001",
    )
    go_repository(
        ...
        sum = "h1:5WjZ3cIbClYC5mJf+H/ODCo36y8rRqtZRxol4Ujln8c=",
        version = "v0.0.0-20191003035328-700b1226c0bd",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:gSmpCfs+R47a4yQPAI4xJ0IPDLTRGXskm6UelqNXpqE=",
        version = "v1.11.0",
    )
    go_repository(
